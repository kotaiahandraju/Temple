						                ...
						                <div class="col-md-4">
											<div class="form-group">
						                        <div class="col-md-offset-4 col-md-8 col-sm-12 col-xs-12">
													...
													<a href="UserThidiWiseReport" class="btn btn-danger" id="cancel">Cancel</a>
						                        </div>
						                    </div>
						                </div>
						            </div>
...
function displayTable(listOrders) {
	...
	var tableHead = '<table class="table table-striped table-hover table-bordered"	id="datatable-buttons">'
		+ '<thead><tr><th class="printbtn" style="text-align: center;"></th><th style="text-align: center;">Name</th><th style="text-align: center;">Pooja-Type</th><th style="text-align: center;">Month</th><th style="text-align: center;">Thidi</th><th style="text-align: center;">Gotram</th><th style="text-align: center;">Mobile</th><th class="printbtn" style="text-align: center;"></th></tr></thead><tbody></tbody></table>';
...
function searchThidiWiseReports(){
	...
	$.ajax({
		type : "POST",
		url : "userSearchThidiWiseReports.json",
