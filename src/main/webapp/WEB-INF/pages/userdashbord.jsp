...
if(userLogin != null)
{
	out.println("<div class='alert alert-success alert-dismissable alert-dismissable fadeIn animated infinite' style='z-index: 10006;'><a class='close' data-dismiss='alert' aria-label='close'>×</a>"+userLogin+"</div>");
												...
												<div class="form-group">
							                    	...
							                    	<div class="col-md-6 col-sm-12 col-xs-12">
							                        	<form:select path="schemeType" class="form-control" required="true" onchange="removeBorder(this.id)" >
															<form:option value="" selected="true" disabled="true">-- Choose Scheme Type --</form:option>
                        					...
                        					<div class="col-md-offset-3 col-md-6">
												<div class="form-group">
				                            		<div class="col-md-offset-2 col-md-8">
														...
														<a href="UserHome" class="btn btn-danger" id="cancel">Cancel</a>
						                        	</div>
							                    </div>
							                </div>
							            </div>
