                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Date Wise Reports</h4>
                        </div>
                    </div>
                </div>
			                    	...
			                    	<div class="row">
			                    		<div class="col-md-4">
											<div class="form-group">
						                    	...
						                    	<div class="col-md-8 col-sm-12 col-xs-12">
						                        	<form:select path="schemeTitle" class="form-control" onchange="removeBorder(this.id)" >
						                ...
						                <div class="col-md-4">
											<div class="form-group">
						                    	...
						                    	<div class="col-md-8 col-sm-12 col-xs-12">
						                        	<form:select path="frommonth" class="form-control" onchange="removeBorder(this.id)" >
						                ...
						                <div class="col-md-4">
											<div class="form-group">
						                    	...
						                    	<div class="col-md-8 col-sm-12 col-xs-12">
						                        	<form:select path="tomonth" class="form-control" onchange="removeBorder(this.id)" >
														<form:option value="" >-- Choose Month --</form:option>
														<form:options items="${englishmonthsDesc}"></form:options>
													</form:select>
						                        </div>
						                    </div>
						                </div>
						            ...
						            <div class="row">
			                    		<div class="col-md-4">
											<div class="form-group">
						                    	...
						                    	<div class="col-md-8 col-sm-12 col-xs-12">
						                        	<form:select path="day" class="form-control" onchange="removeBorder(this.id)" >
						                ...
						                <div class="col-md-4">
											<div class="form-group">
						                        <div class="col-md-offset-4 col-md-8 col-sm-12 col-xs-12">
						                        	<input type="button" id="submitform" class="btn btn-success" value="Search" onclick="searchDateWiseReports()"/>
													<a href="UserDateWiseReport" class="btn btn-danger" id="cancel">Cancel</a>
						                        </div>
						                    </div>
						                </div>
						            </div>
...
function displayTable(listOrders) {
	...
	var tableHead = '<table class="table table-striped table-hover table-bordered"	id="datatable-buttons">'
		+ '<thead><tr><th class="printbtn" style="text-align: center;"></th><th style="text-align: center;">Name</th><th style="text-align: center;">Pooja-Type</th><th style="text-align: center;">Month</th><th style="text-align: center;">Day</th><th style="text-align: center;">Gotram</th><th style="text-align: center;">Mobile</th><th class="printbtn" style="text-align: center;"></th></tr></thead><tbody></tbody></table>';
...
//									+ "<td title='"+orderObj.otherinformation+"'>"+ orderObj.otherinformation+ "</td>"
								+ "<td style='text-align: center;' class='printbtn'>"
...
function searchDateWiseReports(){
