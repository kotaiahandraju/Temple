...
<!-- <script src="http://code.jquery.com/jquery-1.11.1.min.js"></script> -->
	...
	<%
					...
					if (sess.getAttribute("cacheUserBean") == null) {
						...
						System.out.println("rolid22"+rolid22);
						if (rolid22 != 1) {
							RequestDispatcher dispatcher = request.getRequestDispatcher("/Login");
							dispatcher.forward(request, response);
						}/* else{
        ...
        <header id="topnav">
            <div class="topbar-main">
                <div class="container">
                    ...
                    <div class="logo">
                        <!-- Text Logo -->
                        <a href="Home" class="logo">Sri Subrahmanyeswara Swamy Temple</a>
                ...
                <div class="container">
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="">
                                <a href="Home"><i class="mdi mdi-home-map-marker" style="color: red;"></i>Home</a>
                            </li>

                            <li class="">
                                <a href="SchemeHome"><i class="mdi mdi-google-pages" style="color: red;"></i>Schemes</a>
                            </li>
                            
                            <li class="">
                                <a href="ThidiHome"><i class="mdi mdi-bell-plus" style="color: red;"></i>Add Thidi</a>
                            </li>

                            <li class="">
                                <a href="DonorHome"><i class="mdi mdi-account-plus" style="color: red;"></i>Donors</a>
                            </li>

                            <li class="has-submenu">
                                <a href="#"><i class="mdi mdi-book-multiple" style="color: red;"></i>Reports</a>
                                <ul class="submenu">
                                    <li><a href="DateWiseReport">Date Wise Reports</a></li>
                                    <li><a href="ThidiWiseReport">Thidi Wise Reports</a></li>
                                </ul>
                            </li>
                            
                            <li class="">
                                <a href="backupData"><i class="mdi mdi-database" style="color: red;"></i>Database Backup</a>
                            </li>
                        </ul>
                        <!-- End navigation menu -->
                    </div> <!-- end #navigation -->
